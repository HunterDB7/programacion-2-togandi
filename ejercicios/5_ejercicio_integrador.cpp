...
if(arreglo == nullptr && arreglo <= 0){
    cout << "Arreglo invalido."<<endl;
    return;
}else{
    for(int i=0; i < tamanio; i++){
        cout << "Elemento en la posicion"<< i << " es: "<< arreglo[i]<< endl;
    }
}
